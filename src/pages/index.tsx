...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Cover Book Generator`}</title>

        <meta
          name="description"
          content="Welcome to Cover Book Generator, your ultimate platform to build stunning book covers with ease and precision. Transforming ideas into art."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1592496431122-2349e0fbc666?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxib29rJTIwY292ZXJ8ZW58MHx8fHwxNjk3NTAwNTYxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@morganhousel?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Morgan Housel`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Cover Book Generator`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Cover Book Generator, your ultimate platform to build stunning book covers with ease and precision. Transforming ideas into art.`}
            </Text>
            <Box
