...
export function useCoverBookFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCoverBookFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.cover_book.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCoverBookCount<T extends Prisma.cover_bookCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.cover_bookCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useCoverBookCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.cover_book.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCoverBookFindManyWithCount<
  T extends Prisma.cover_bookFindManyArgs,
  R extends { data: GetFindResult<Prisma.$cover_bookPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.cover_bookFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCoverBookFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.cover_book.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCoverBookFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCoverBookFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.cover_book.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGenreFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGenreFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.genre.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGenreCount<T extends Prisma.genreCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.genreCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useGenreCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.genre.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGenreFindManyWithCount<
  T extends Prisma.genreFindManyArgs,
  R extends { data: GetFindResult<Prisma.$genrePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.genreFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGenreFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.genre.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGenreFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGenreFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.genre.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLanguageFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLanguageFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.language.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLanguageCount<T extends Prisma.languageCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.languageCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useLanguageCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.language.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLanguageFindManyWithCount<
  T extends Prisma.languageFindManyArgs,
  R extends { data: GetFindResult<Prisma.$languagePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.languageFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLanguageFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.language.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLanguageFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLanguageFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.language.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
