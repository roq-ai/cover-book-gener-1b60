...
import { useLanguageFindFirst, useRoqClient } from 'lib/roq';

import { LanguageInterface } from 'interfaces/language';

function LanguageViewPage() {
  ...
  const { data, error, isLoading } = useLanguageFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('language', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/languages/edit/${id}`} passHref legacyBehavior>
                    <Button
