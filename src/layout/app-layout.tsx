...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Genres', path: '/genres', entity: 'genre', service: AccessServiceEnum.PROJECT, icon: FiTag },
    { name: 'Languages', path: '/languages', entity: 'language', service: AccessServiceEnum.PROJECT, icon: FiGlobe },
