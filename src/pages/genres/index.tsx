...
import { useRoqClient, useGenreFindManyWithCount } from 'lib/roq';
...
export function GenreListPage(props: GenreListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useGenreFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.genre.delete({ where: { id } });
      await mutate();
    } catch (error) {
